...
void setup(){
  ...
  feld = loadImage("./data/ttt.png");
  kreuz = loadImage("./data/kreuz.png");
  kreis = loadImage("./data/kreis.png");
  gewonnen = loadImage("./data/YouWon.png");
  verloren = loadImage("./data/YouLose.png");
  unentschieden = loadImage("./data/unentschieden.png");
  weiss = loadImage("./data/weiss.png");
  in = loadImage("./data/Spielregeln.png");
  robo = loadImage("./data/robo.png");
  ufo = loadImage("./data/ufos.png");
